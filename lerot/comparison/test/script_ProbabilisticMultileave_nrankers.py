...
parser.add_argument("n_rankers", help="number of rankers ")
...
class Experiment(object):
    ...
    def run(self, n_impressions, n_rankers):
        ...
        for i in range(1,n_impressions+1):
            td_preferences, ((pi_r1, pi_r2), pi_creds), sbpm_pref10000 = self.impression()
           ...
           # total_spm1000 += sbpm_pref1000
            ...
            for matrix in [total_td/i, total_pi/count_pi,  1-total_spm10000/i]:
        ...
        return [ self.preference_error(matrix) for matrix in [total_td, total_pi, 1-total_spm10000]]
    ...
    def impression(self):
        ...
        return td_preferences, ((pi_r1, pi_r2), pi_creds), sbpm_pref10000
